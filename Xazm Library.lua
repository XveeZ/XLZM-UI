...
local Custom = {} do
  Custom.ColorRGB = Color3.fromRGB(86, 223, 71)
  ...
  function Custom:GetLogo()
    if getcustomasset and writefile then
      writefile("XazmLogo.png", game:HttpGet("https://raw.githubusercontent.com/XveeZ/XLZM-UI/refs/heads/main/SmartBG_2025-01-21_5bd3bb02-e8fe-40a3-8942-5bdcfe4c58ed.png"))
      return getcustomasset("XazmLogo.png")
    else
      return ""
    end
  end
...
local Xazm_Library, Notification = {}, {}

Xazm_Library.Unloaded = false

function Xazm_Library:SetNotification(Config)
...
function Xazm_Library:CreateWindow(Config)
  local Title = Config[1] or Config.Title or ""
  local Description = Config[2] or Config.Description or ""
  ...
  local XazmHubGui = Custom:Create("ScreenGui", {
    ZIndexBehavior = Enum.ZIndexBehavior.Sibling
  }, RunService:IsStudio() and Player.PlayerGui or (gethui() or cloneref(game:GetService("CoreGui")) or game:GetService("CoreGui")))
  ...
  local DropShadowHolder = Custom:Create("Frame", {
    ...
    ZIndex = 0,
    Name = "DropShadowHolder",
    Position = UDim2.new(0, (XazmHubGui.AbsoluteSize.X // 2 - 455 // 2), 0, (XazmHubGui.AbsoluteSize.Y // 2 - 350 // 2))
  }, XazmHubGui)
  ...
  Close.Activated:Connect(function()
    ...
    if XazmHubGui then XazmHubGui:Destroy() end
		if not Xazm_Library.Unloaded then Xazm_Library.Unloaded = true end
	end)
